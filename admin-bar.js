...
onAuthStateChanged(auth, (user) => {
  ...
  barra.innerHTML = `
    ...
    <a href="/radar-de-ofertas/painel.html" style="color:#E9EEF3; text-decoration:none; border-bottom:1px solid #232B36;">Painel de análise</a>
    <a href="https://github.com/atosdutrafreitas-wq/radar-de-ofertas/upload/main/fila" target="_blank" rel="noopener" style="color:#E9EEF3; text-decoration:none; border-bottom:1px solid #232B36;">Enviar publicações</a>
  `;
